...
FORBIDDEN_PATTERN_GUIDES = [
    ...
    ("자극적으로 소비", "독자를 가르치는 문구 대신 기사 속 발언과 상황을 더 풀어 쓰세요."),
    ("자극적인 표현", "기사 밖 평가를 덧붙이지 말고 실제 표현이나 반응을 그대로 설명하세요."),
    ("조롱성 표현", "훈계성 해설 대신 기사에 나온 말과 당사자 반응을 풀어 쓰세요."),
    ("실제로 남겨야 할", "무엇을 남겨야 한다고 가르치지 말고 기사 내용 자체를 이어 쓰세요."),
    ("본문에서는", "글 작성 설명 대신 기사 속 장면이나 발언으로 바로 이어 쓰세요."),
    ("본문에는", "글 작성 설명 대신 기사 속 장면이나 발언으로 바로 이어 쓰세요."),
    ("본문에 나온", "글 작성 설명 대신 기사 속 장면이나 발언으로 바로 이어 쓰세요."),
    ("이번 글에서는", "글 작성 설명 대신 기사 속 장면이나 발언으로 바로 이어 쓰세요."),
    ("핵심 포인트", "보고서식 라벨 대신 기사에 나온 말이나 장면을 그대로 쓰세요."),
    ("결국 핵심은", "보고서식 요약 문구 대신 기사에 나온 말이나 장면을 그대로 쓰세요."),
    ("반응이 붙기 쉽", "왜 반응이 생겼는지 분석하지 말고 기사 속 말과 짧은 감상만 쓰세요."),
    ("반응이 붙은 이유", "왜 반응이 생겼는지 분석하지 말고 기사 속 말과 짧은 감상만 쓰세요."),
    ("붙은 이유", "분석형 소제목 대신 기사 속 장면이나 발언을 소제목으로 쓰세요."),
    ("번진 이유", "분석형 소제목 대신 기사 속 장면이나 발언을 소제목으로 쓰세요."),
    ("언급이 붙은 이유", "분석형 소제목 대신 기사 속 장면이나 발언을 소제목으로 쓰세요."),
    ("기사 제목에", "제목 선정 기준을 설명하지 말고 기사 속 장면이나 발언을 바로 쓰세요."),
    ("기사 제목으로", "제목 선정 기준을 설명하지 말고 기사 속 장면이나 발언을 바로 쓰세요."),
    ("제목에는", "제목 선정 기준을 설명하지 말고 기사 속 장면이나 발언을 바로 쓰세요."),
    ("제목에 잡", "제목 선정 기준을 설명하지 말고 기사 속 장면이나 발언을 바로 쓰세요."),
    ("제목으로 잡", "제목 선정 기준을 설명하지 말고 기사 속 장면이나 발언을 바로 쓰세요."),
    ("따로 제목", "제목 선정 기준을 설명하지 말고 기사 속 장면이나 발언을 바로 쓰세요."),
    ("말이 이어지고 있습니다", "반복적인 연결 문구 대신 누가 무엇을 말했는지 구체적으로 쓰세요."),
    ("함께 붙", "반복적인 연결 문구 대신 실제로 함께 나온 장면이나 발언을 구체적으로 쓰세요."),
    ("같이 붙", "반복적인 연결 문구 대신 실제로 함께 나온 장면이나 발언을 구체적으로 쓰세요."),
    ("말이 붙", "반복적인 연결 문구 대신 실제로 함께 나온 장면이나 발언을 구체적으로 쓰세요."),
    ...
    ("나눠 읽어야", "독자에게 판단법을 안내하지 말고 기사에 나온 사실 관계를 평서로 쓰세요."),
    ("확인하고 넘어가면", "독자에게 판단법을 안내하지 말고 기사에 나온 사실 관계를 평서로 쓰세요."),
    ("뒤따라야", "책임을 촉구하는 권고문 대신 기사에서 확인된 말과 재판 내용을 쓰세요."),
