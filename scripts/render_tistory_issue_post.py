    ...
    return [
        ...
        (
            ...
            [
                ...
                "시청자 반응이 붙은 이유는 단순히 소문 때문만은 아닙니다. 아무래도 방송에서 불편하게 본 장면들이 있었고, 그 위에 온라인 주장이 얹히면서 말이 더 커진 것으로 보입니다.",
            ],
        ),
        (
            "통편집설로 번진 이유",
...
def core_summary_fallback(item: dict) -> str:
    ...
    if item.get("safety_flags"):
        return (
            f"이번 이야기는 {entity}{particle} 둘러싼 방송 장면에 온라인 반응이 붙으면서 커진 흐름입니다. "
